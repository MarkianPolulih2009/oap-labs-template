...
Репозиторій: `oap-labs` (приватний репозиторій на GitHub).
...
```text
<вивід git log --oneline після виконання комітів>
```

Приклад необхідної історії з не менше ніж трьома комітами:

```text
<hash3> ЛР2: додано програму варіанта 16
<hash2> ЛР2: виправлено помилки task1
<hash1> ЛР2: створено структуру lab02
```
