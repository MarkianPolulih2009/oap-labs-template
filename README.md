...
- [Скріншоти виконання](lab04/screenshots/)
...
Усі програми компілюються з прапорами `-Wall`, `-Wextra` та `-pedantic`.
